...
from apps.oinkerprofile.views import oinker_profile, edit_profile, followers, follows, follow_oinker, unfollow_oinker
...
urlpatterns = [
    ...
    path('u/<str:username>', oinker_profile, name="oinkerprofile"),
